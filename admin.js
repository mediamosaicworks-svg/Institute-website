...
const defaults = {
  ...
  content:{bodyFont:'Manrope',headingFont:'Manrope',admissionsLabel:'Admissions Open · 2026 Batch',coursesButton:'Explore Courses',placementButton:'Placement Stories',coursesHeading:'Skills that work.|A *portfolio* that speaks.',coursesIntro:'Structured courses, mentor feedback and real-world briefs—from beginner to job-ready.',portfolioHeading:'Learned here.|*Created their own.*',portfolioIntro:'Selected student projects across editing, motion, animation and visual design.',placementsHeading:'Where talent met|*the right opportunity.*',placementsIntro:'Our learners have built careers in studios, agencies and content teams.',aboutHeading:'Less classroom.|More *creative studio.*',contactHeading:'Your creative career|*starts here.*',contactIntro:'Book a free counselling session. We will help you choose the right course and career path.',localHeading:'Graphic Design,|*Motion Graphics* and|Video Editing Courses in Muzaffarnagar',localIntro:'Mosaic Works Institute provides project-based graphic design, video editing, animation, VFX and motion graphics training in Muzaffarnagar.',course1Title:'Motion Graphics|& Animation',course1Desc:'After Effects, 2D/3D motion, title design and visual storytelling.',course1Bg:'',course2Title:'Video Editing|& Post Production',course2Desc:'Editing grammar, colour, sound and workflows from long-form videos to reels.',course2Bg:'',course3Title:'Graphic Design|& Branding',course3Desc:'Typography, identity, social creatives and print-ready brand systems.',course3Bg:'',course4Title:'3D Animation|& Visualisation',course4Desc:'Modelling, lighting, materials, animation and cinematic rendering.',course4Bg:''},
...
const contentGroups=[
  ...
  {title:'Courses Section',fields:[['coursesHeading','Section heading'],['coursesIntro','Section description'],['course1Title','Course 1 title'],['course1Desc','Course 1 description'],['course1Bg','Course 1 background image URL/path'],['course2Title','Course 2 title'],['course2Desc','Course 2 description'],['course2Bg','Course 2 background image URL/path'],['course3Title','Course 3 title'],['course3Desc','Course 3 description'],['course3Bg','Course 3 background image URL/path'],['course4Title','Course 4 title'],['course4Desc','Course 4 description'],['course4Bg','Course 4 background image URL/path']]},
...
const courseMeta={
  ...
  animation:{label:'Animation Course',url:'animation-course-muzaffarnagar.html'},
